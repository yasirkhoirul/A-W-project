...
void main() {
  ...
  group('getProvinsi', () {
    ...
    test('should return list of ProvinsiModel when call is successful', () async {
      // Arrange
      when(mockRemoteDatasource.getProvinsi())
    ...
    test('should return UnknownFailure when data is null', () async {
      ...
      // Assert
      expect(result, equals(const Left(UnknownFailure('Data provinsi kosong'))));
      verify(mockRemoteDatasource.getProvinsi());
    });
    ...
    test('should return NetworkFailure when HttpNetworkException is thrown', () async {
      // Arrange
      when(mockRemoteDatasource.getProvinsi())
      ...
      expect(result.fold((failure) => failure.message, (_) => ''), 'Tidak ada koneksi internet');
      verify(mockRemoteDatasource.getProvinsi());
    });

    test('should return HttpApiFailure when HttpApiException is thrown', () async {
      // Arrange
      const tException = HttpApiException('Unauthorized: Kunci API tidak valid');
      when(mockRemoteDatasource.getProvinsi())
    ...
    test('should return UnknownFailure when unknown exception is thrown', () async {
      // Arrange
      when(mockRemoteDatasource.getProvinsi())
  ...
  group('getKota', () {
    ...
    test('should return list of KotaModel when call is successful', () async {
      // Arrange
      when(mockRemoteDatasource.getKota(tProvinsiId))
    ...
    test('should return HttpApiFailure when HttpApiException is thrown', () async {
      // Arrange
      const tException = HttpApiException('Not Found: Sumber daya tidak ditemukan');
      when(mockRemoteDatasource.getKota(tProvinsiId))
          .thenThrow(tException);
  ...
  group('getDistrik', () {
    ...
    const List<DistrikModel> tDistrikList = [
      ...
      DistrikModel(id: '5817', name: 'BOJONGSARI'),
    ];
    ...
    test('should return list of DistrikModel when call is successful', () async {
      // Arrange
      when(mockRemoteDatasource.getDistrik(tKotaId))
    ...
    test('should return HttpApiFailure when HttpApiException is thrown', () async {
      // Arrange
      const tException = HttpApiException('Bad Request: Permintaan tidak valid');
      when(mockRemoteDatasource.getDistrik(tKotaId))
          .thenThrow(tException);
    ...
    test('should return DatabaseFailure when HttpApiException with Server error is thrown', () async {
      // Arrange
      const tException = HttpApiException('Internal Server Error: Kesalahan pada server');
      when(mockRemoteDatasource.getDistrik(tKotaId))
          .thenThrow(tException);
      ...
      result.fold(
        (failure) {
          ...
          expect(failure.message, 'Internal Server Error: Kesalahan pada server');
        },
        (_) => fail('Should return Left'),
      );
      verify(mockRemoteDatasource.getDistrik(tKotaId));
    ...
    test('should return HttpApiFailure when HttpUnknownException is thrown', () async {
      // Arrange
      const tException = HttpUnknownException('Terjadi kesalahan yang tidak diketahui');
      when(mockRemoteDatasource.getDistrik(tKotaId))
          .thenThrow(tException);
